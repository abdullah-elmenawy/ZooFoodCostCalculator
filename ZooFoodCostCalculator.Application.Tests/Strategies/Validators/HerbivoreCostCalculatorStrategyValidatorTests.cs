...
{
    public class HerbivoreCostCalculatorStrategyValidatorTests
    {
        HerbivoreCostCalculatorStrategyValidator validator;
        [SetUp]
        public void Setup()
        {
            validator = new HerbivoreCostCalculatorStrategyValidator();
        }
        [Test]
