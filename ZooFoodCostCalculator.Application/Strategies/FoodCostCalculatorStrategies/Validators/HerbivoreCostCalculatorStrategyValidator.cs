...
{
    public class HerbivoreCostCalculatorStrategyValidator : ICostCalculatorStrategyValidator
    {
        public void Validate(List<PricesItem> prices, List<AnimalFood> animalFoods, List<ZooAnimal> zooAnimals)
        {
            Console.WriteLine($"{nameof(HerbivoreCostCalculatorStrategy)}.{nameof(Validate)} validation started");
            ...
            Console.WriteLine($"{nameof(HerbivoreCostCalculatorStrategy)}.{nameof(Validate)} validation passed");
        }
    }
}
