...
{
    public class OmnivoreCostCalculatorStrategyValidatorTests
    {
        OmnivoreCostCalculatorStrategyValidator validator;
        [SetUp]
        public void Setup()
        {
            validator = new OmnivoreCostCalculatorStrategyValidator();
        }
        [Test]
        ...
        public void Validate_Should_ThrowExceptionForNullMeatPercentage()
        {
            var prices = new List<PricesItem>
            {
                new PricesItem(FoodType.Fruit.Name, 15.4f),
